...
import com.example.mihu.databinding.ActivityLoginWorkerBinding
...
class LoginWorkerActivity : AppCompatActivity() {
    ...
    private val viewModel: LoginWorkerViewModel by viewModels { ViewModelFactory.getInstance(this) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myTextView.setOnClickListener {
            val intent = Intent(this, RegisterWorkerActivity::class.java)
            ...
            loginButton.setOnClickListener {
                if (validateForm()) {
                    ...
                    viewModel.login(email, password)
                        .observe(this@LoginWorkerActivity) { result ->
                            if (result != null) {
                                when (result) {
                                    is Result.Loading -> {
                                        showLoading(true)

...
//                    val intent = Intent(itemView.context, com.example.mihu.ui.worker.task.HistoryFragment::class.java)
//                    intent.putExtra(com.example.mihu.ui.worker.task.HistoryFragment.category, data.name)
//                    intent.putExtra(com.example.mihu.ui.worker.task.HistoryFragment.status, data.status)
//                    intent.putExtra(com.example.mihu.ui.worker.task.HistoryFragment.price, data.price)
//
